package com.example.pgntogifconverter.util.twentyone.day6
...
class Day6 {
    private val fileInput =
        File("/Users/oziomaogbe/AndroidStudioProjects/PgnToGifConverter/app/src/test/java/com/example/pgntogifconverter/util/twentyone/day6/input.txt").readLines()
            .first().split(",")
            .map {
                it.toInt()
            }
