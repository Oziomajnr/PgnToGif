package com.example.pgntogifconverter.util.twentyone.day11
...
class Part2 {
    private val fileInput =
        File("/Users/oziomaogbe/AndroidStudioProjects/PgnToGifConverter/app/src/test/java/com/example/pgntogifconverter/util/twentyone/day11/input.txt").readLines()
            .map {
                it.map {
                    it.digitToInt()
                }
