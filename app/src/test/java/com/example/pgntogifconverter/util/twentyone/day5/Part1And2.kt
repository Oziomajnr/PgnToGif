package com.example.pgntogifconverter.util.twentyone.day5
...
class Part1 {
    private val fileInput =
        File("/Users/oziomaogbe/AndroidStudioProjects/PgnToGifConverter/app/src/test/java/com/example/pgntogifconverter/util/twentyone/day5/input.txt").readLines()
