...
import com.example.pgntogifconverter.util.twentyone.day12.Cave
...
class Part2 {
    ...
    private val fileInput =
        File("/Users/oziomaogbe/AndroidStudioProjects/PgnToGifConverter/app/src/test/java/com/example/pgntogifconverter/util/twentyone/day12/input.txt").readLines()
            .map {
